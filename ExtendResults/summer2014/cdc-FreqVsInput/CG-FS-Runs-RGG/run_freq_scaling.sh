#!/bin/bash
exe_dir=/home/wwang/shared/grappolo-sb-version-Allan/RGG-CG-FS-Runs
...
do 
 ...
 do  
   export OMP_NUM_THREADS=$num
     ...
     ./graphClustering -f ../grappolo-sb-version-Allan-Wei-Modify-for-OpenMPRuntime/wei_rgg.bin -b -c  >> $exe_dir/freq-$freq-num$num.output
     done
   done 
