...
do
       grep App       freq-$freq.output |grep socket |awk '{print $4}' > App
       grep Parallel  freq-$freq.output  |awk '{print $4}' > parallel
       grep "Loop 2 " freq-$freq.output |grep Power |awk '{print $6}' > 2
       grep "Loop 7 " freq-$freq.output |grep Power |awk '{print $6}' > 7
       grep "Loop 0 " freq-$freq.output |grep Power |awk '{print $6}' > 0 
       grep "Loop 1 " freq-$freq.output |grep Power |awk '{print $6}' > 1
       grep "Loop 3 " freq-$freq.output |grep Power |awk '{print $6}' > 3
       grep "Loop 8 " freq-$freq.output |grep Power |awk '{print $6}' > 8
